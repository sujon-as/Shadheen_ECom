...
<div class="dropdown cart-dropdown cart-offcanvas mr-0 mr-lg-2">
    ...
    <div class="dropdown-box" id="cart-dropdown-box">
        <div class="cart-header" style="color: #0094c9 !important;">
        ...
        <div class="products" id="cart-items-list">
            @forelse($cartItems as $item)
                <div class="product product-cart">
                    <div class="product-detail" style="color: #0094c9 !important;">
                        <a href="{{ route('product-details', ['product_id' => $item['id']]) }}" class="product-name">{{ $item['title'] }}</a>
                        <div class="price-box">
                            <span class="product-quantity">1</span>
                            <span class="product-price" style="color: #0094c9 !important;">৳{{ $item['price'] }}</span>
                        </div>
                    </div>
            ...
            @empty
                <p class="text-center p-3" style="color: #0094c9 !important;">Cart is empty.</p>
            @endforelse
        </div>

        <div class="cart-total" style="color: #0094c9 !important;">
        ...
        <div class="cart-action">
            ...
            <a href="{{ route('checkout') }}" class="btn btn-primary btn-rounded" style="background-color: #0094c9 !important; border-color: #0f1535 !important">Checkout</a>
        </div>
    </div>
</div>
