          ...
          <div class="container">
            <section class="content-title-section">
              ...
              <p class="description text-center">
                You can show the faqs with <b>Wolmart Elements</b> easily.
              </p>
            </section>
              ...
              <div class="row">
                    ...
                    <div class="card">
                      ...
                      <div id="collapse1-1" class="card-body expanded">
                        <p class="mb-0">
                          ...
                          non isse faucibus Ultrices eros in cursus turpis massa
                          tincidunt. Ante in nibh mauri eger enim neque volu
                    ...
                    <div class="card">
                      <div class="card-header">
                        <a href="#collapse1-2" class="expand"
                          >How Long Will it Take to Get My Package?</a
                        >
                      </div>
                ...
                <div class="col-md-6 mb-8">
                  ...
                  >
                    <div class="card">
                      <div class="card-header">
                        <a href="#collapse1-3" class="collapse"
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  >
                    <div class="card">
                      <div class="card-header">
                        <a href="#collapse2-2" class="collapse"
              ...
              <div class="row">
                <div class="col-md-6 mb-8">
                  ...
                  >
                    ...
                    <div class="card">
                      <div class="card-header">
                        <a href="#collapse3-3" class="expand"
                          >Do I Need an Account to Place an Order?</a
                        >
                      </div>
                    ...
                    <div class="card">
                      <div class="card-header">
                        <a href="#collapse3-5" class="expand"
                          >How Can I Return a Product?</a
                        >
                      </div>
                ...
                <div class="col-md-6 mb-8">
                  ...
                  >
                    <div class="card">
                      <div class="card-header">
                        <a href="#collapse3-2" class="collapse"
                          >How Can I or Change My Order?</a
                        >
                      </div>
                    ...
                    <div class="card">
                      <div class="card-header">
                        <a href="#collapse3-4" class="expand"
                          >How do I Track Order?</a
                        >
                      </div>
