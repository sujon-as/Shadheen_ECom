                    ...
                    <div class="swiper-wrapper row cols-1 gutter-no">
                        <div class="swiper-slide">
                            <figure class="product-image">
                                <img
                                    src="{{ asset('assets/images/products/popup/1-440x494.jpg') }}"
                        ...
                        <div class="swiper-slide">
                            <figure class="product-image">
                                <img
                                    src="{{ asset('assets/images/products/popup/2-440x494.jpg') }}"
                        ...
                        <div class="swiper-slide">
                            <figure class="product-image">
                                <img
                                    src="{{ asset('assets/images/products/popup/3-440x494.jpg') }}"
                        ...
                        <div class="swiper-slide">
                            <figure class="product-image">
                                <img
                                    src="{{ asset('assets/images/products/popup/4-440x494.jpg') }}"
                ...
                >
                    <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                        <div class="product-thumb swiper-slide">
                            <img
                                src="{{ asset('assets/images/products/popup/1-103x116.jpg') }}"
                                alt="Product Thumb"
                                width="103"
                                height="116"
                            />
                        ...
                        <div class="product-thumb swiper-slide">
                            <img
                                src="{{ asset('assets/images/products/popup/2-103x116.jpg') }}"
                                alt="Product Thumb"
                                width="103"
                                height="116"
                            />
                        ...
                        <div class="product-thumb swiper-slide">
                            <img
                                src="{{ asset('assets/images/products/popup/3-103x116.jpg') }}"
                                alt="Product Thumb"
                                width="103"
                                height="116"
                            />
                        ...
                        <div class="product-thumb swiper-slide">
                            <img
                                src="{{ asset('assets/images/products/popup/4-103x116.jpg') }}"
                                alt="Product Thumb"
                                width="103"
                                height="116"
                            />
        ...
        <div class="col-md-6 overflow-hidden p-relative">
            <div class="product-details scrollable pl-0">
                ...
                <div class="product-bm-wrapper">
                    <figure class="brand">
                        <img
                            src="{{ asset('assets/images/products/brand/brand-1.jpg') }}"
                            alt="Brand"
                            width="102"
                            height="48"
                        />
