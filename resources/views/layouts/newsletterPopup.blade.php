<div class="newsletter-popup mfp-hide">
    <div class="newsletter-content">
        ...
        <h2 class="ls-25">Sign up to {{ session('about_us.institute_name') ?? 'SMC Global' }}</h2>
        <p class="text-light ls-10">
            Join with {{ session('about_us.institute_name') ?? 'SMC Global' }} for getting special offers.
        </p>
        <form
            action="#"
            method="get"
