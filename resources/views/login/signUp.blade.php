<form action="{{ route('register.submit') }}" method="POST">
    ...
    <div class="form-group">
        <label style="color: #0094c9 !important;">Full Name *</label>
        <input type="text" class="form-control" name="name" required>
    </div>

    <div class="form-group">
        <label style="color: #0094c9 !important;">Mobile Number *</label>
        <input type="text" class="form-control" name="mobile" required>
    </div>

    <div class="form-group">
        <label style="color: #0094c9 !important;">Email *</label>
        <input type="email" class="form-control" name="email" required>
    </div>

    <div class="form-group">
        <label style="color: #0094c9 !important;">NID *</label>
        <input type="text" class="form-control" name="nid" required>
    </div>

    <div class="form-group">
        <label style="color: #0094c9 !important;">Gender *</label>
    ...
    <div class="form-group">
        <label style="color: #0094c9 !important;">Country *</label>
        <input type="text" class="form-control" name="country" value="Bangladesh" required>
    </div>

    <div class="form-group">
        <label style="color: #0094c9 !important;">Password *</label>
        <input type="password" class="form-control" name="first_password" required>
    </div>

    <div class="form-group">
        <label style="color: #0094c9 !important;">Confirm Password *</label>
        <input type="password" class="form-control" name="re_password" required>
    </div>

    <div class="form-group">
        <label style="color: #0094c9 !important;">Referral ID (Optional)</label>
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-primary w-100" style="background-color: #0094c9 !important; color: white !important; border-color: #0f1535 !important;">Register</button>
    </div>
</form>
...
<div class="form-footer text-center mt-4">
    <p>
        ...
        <a href="{{ route('login') }}" class="text-primary font-weight-bold" style="color: #0094c9 !important;">
            Login
        </a>
    </p>
</div>
