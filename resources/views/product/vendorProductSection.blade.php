            ...
            <div class="swiper-slide product">
                <figure class="product-media">
                    <a href="product-default.html">
                        <img
                            src="{{ asset('assets/images/products/default/1-1.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                        />
                        <img
                            src="{{ asset('assets/images/products/default/1-2.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                        />
...
{{--                        ></a>--}}
            ...
            <div class="swiper-slide product">
                <figure class="product-media">
                    <a href="product-default.html">
                        <img
                            src="{{ asset('assets/images/products/default/2.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                        />
...
{{--                        ></a>--}}
                ...
                <div class="product-details">
                    ...
                    <h4 class="product-name">
                        <a href="product-default.html"
                        >Mini Multi-Functional Cooker</a
                        >
                    </h4>
                    <div class="ratings-container">
                        <div class="ratings-full">
                    ...
                    <div class="product-pa-wrapper">
                        <div class="product-price">
                            ...
                            <del class="old-price">$534.00</del>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide product">
                <figure class="product-media">
                    <a href="product-default.html">
                        <img
                            src="{{ asset('assets/images/products/default/3.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                        />
...
{{--                        ></a>--}}
                ...
                <div class="product-details">
                    ...
                    <div class="product-pa-wrapper">
                        <div class="product-price">
                            <ins class="new-price">$278.00</ins>
                            <del class="old-price">$310.00</del>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide product">
                <figure class="product-media">
                    <a href="product-default.html">
                        <img
                            src="{{ asset('assets/images/products/default/4-1.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                        />
                        <img
                            src="{{ asset('assets/images/products/default/4-2.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                        />
