            ...
            <div class="swiper-slide product">
                <figure class="product-media">
                    <a href="product-default.html">
                        <img
                            src="{{ asset('assets/images/products/default/5.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                        />
...
{{--                        ></a>--}}
            ...
            <div class="swiper-slide product">
                <figure class="product-media">
                    <a href="product-default.html">
                        <img
                            src="{{ asset('assets/images/products/default/6.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                        />
...
{{--                        ></a>--}}
            ...
            <div class="swiper-slide product">
                <figure class="product-media">
                    <a href="product-default.html">
                        <img
                            src="{{ asset('assets/images/products/default/7-1.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                        />
                        <img
                            src="{{ asset('assets/images/products/default/7-2.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                        />
...
{{--                        ></a>--}}
            ...
            <div class="swiper-slide product">
                <figure class="product-media">
                    <a href="product-default.html">
                        <img
                            src="{{ asset('assets/images/products/default/8.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                        />
...
{{--                        ></a>--}}
                ...
                <div class="product-details">
                    ...
                    <div class="product-pa-wrapper">
                        <div class="product-price">$230.95</div>
                    </div>
                </div>
            </div>
        </div>
