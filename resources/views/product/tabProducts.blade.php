<div class="tab tab-nav-boxed tab-nav-underline product-tabs">
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
            <a href="#product-tab-description" class="nav-link active" style="color: #0094c9 !important;"
            >Description</a
            >
        </li>
        {{--
        ...
        <div class="tab-pane active" id="product-tab-description">
            <div class="row mb-4">
                <div class="col-md-6 mb-5">
                    <h4
                        class="title tab-pane-title font-weight-bold mb-2" style="color: #0094c9 !important;"
                    >
                        Detail
                    </h4>
                    @if($product['title'])
                        <p class="mb-4" style="color: #0094c9 !important;">
                            {{ $product['title'] }}
                        </p>
                    @endif
                    ...
                    <p class="mb-4" style="color: #0094c9 !important;">Note: Cash On Delivery.</p>
